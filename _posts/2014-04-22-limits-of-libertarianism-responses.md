...
Despite [Cantwell calling me an antipropertarian](http://www.christophercantwell.com/2014/04/20/will-moyer-adding-libertarianism/), I never said I was against property. I like owning stuff. I don't want free stuff from other people against their will. I recognize that in a situation of scarcity and conflict over available resources, private property (homesteading, contractual transfer, self-ownership) is the best framework for allocating those resources in a just (and rational) way.
...
I look at the internet and the digitization of stuff that used to require a physical presence, I look at 3D printing, I look at possible new energy resources, and I see a potential future where property rights might not be as foundational to society as they are now. And if that future is better for humanity overall, I'm fine with redefining or discarding what it means for something to be property. That's what I meant when I said, "my goal isn't a society based on property rights. My goal is human flourishing."
